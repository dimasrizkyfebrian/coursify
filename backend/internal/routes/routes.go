...
func (router *Router) RegisterRoutes(r chi.Router) {
	...
	// --- Public Routes ---
	r.Post("/register", router.UserHandler.Register)
	r.Post("/login", router.UserHandler.Login)
	...
	r.Group(func(r chi.Router) {
		...
		// Profile
		r.Get("/profile", router.UserHandler.GetProfile)
		r.Put("/profile/avatar", router.UserHandler.UploadAvatar)

		// Student Routes
		r.Post("/courses/{id}/enroll", router.CourseHandler.EnrollInCourse)
